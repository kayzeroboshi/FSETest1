...
def loop():
    ...
    try:
        ...
        while True:
            ...
            print(f"first {state} before first if statement")        
            if button_state == 1 and is_pressed == False:
                is_pressed = True
                if state == 0:
                    state = 1
                else:
            ...
            elif button_state == 0 and is_pressed == True:
                is_pressed = False
                
            
            print(f"second {state} before first if statement")
            if state == 1 :
                ...
                if dis < 94:  # If the distance is less than 20 cm
